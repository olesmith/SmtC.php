...
include_once("Application/LeftMenu.php");
include_once("Application/SendMail.php");
include_once("Application/Login.php");
include_once("Application/Session.php");
include_once("Application/SubModules.php");
include_once("Application/ModPerms.php");
include_once("Application/Backup.php");
include_once("Application/Modules.php");
include_once("Application/Setup.php");
include_once("Application/Message.php");
include_once("Application/Help.php");
include_once("Application/Perms.php");
include_once("Application/Profiles.php");
include_once("Application/Users.php");
include_once("Application/Logs.php");
include_once("Application/Handlers.php");
include_once("Application/Language.php");
include_once("Application/CGIVars.php");
...
class Application extends ApplicationCGIVars
{
    ...
    var $Latex_PDF_Send=True; //set to FALSE to disable.
    ...
    {        
        ...
        if
            (
                $this->ApplicationObj()->DBHash[ "Debug" ]>3
            )
        {
            $this->Htmls_Echo
            (
    ...
    function Profile2Application()
    {
        ...
        if ($this->__Profile__=="") { $this->__Profile__="Public"; }
