...
function Show_Elements_By_Class(classid,display,newcolor="",tagname="")
{
    ...
    if (tagname)
    {
        //console.log("Show_Elements_By_Class",classid,elements.length,"Tag:",tagname);
    }
...
function Hide_Elements_By_Class(classid,display,tagname="")
{
    ...
    //if (tagname)
    //{
        //console.log(tagname,classid,"Hide",elements.length,"elements");
    //}
    ...
    for (let n = 0; n < elements.length; n++)
    {
        ...
        //console.log("Hide",n,classid);
        Hide_Element(elements[n],"none");
    }
...
function Element_Colspan(element_id,colspan)
{
    let element  = Get_Element_By_ID(element_id);
...
function Remove_Children_ByID(elementid)
{
    let element=Get_Element_By_ID(elementid);
    if (element)
    {
        ...
        console.log(elementid,n,"children removed");
    }
}
