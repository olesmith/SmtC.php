...
trait MyMod_HorMenu
{
            ...
            (
                ...
                (
                    ...
                    (
                        ...
                        array_merge
                        (
                            $this->ApplicationObj()->MyApp_Module_Group_Menu_Horisontal
                            (
                                $this
                            ),
                            $this->MyMod_Module_Menu_Horisontal
                            (
                                $id
                            ),
    ...
    function MyMod_Module_Menu_Horisontal($id,$item=array())
    {
        return array();
    }
