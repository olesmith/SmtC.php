...
trait MyMod_Item_Row
{
    ...
    function MyMod_Item_Table_Rows($edit,$item,$datas,$plural=TRUE,$nodatatitles=False)
    {
        $rows=array();
        foreach ($datas as $data)
        {
            ...
            (
                $rows,
                $this->MyMod_Item_Table_Row
                (
                    $edit,$item,$data,$plural,$nodatatitles
                )
            );
        }
