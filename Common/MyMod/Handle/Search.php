...
{
    var $__MyMod_Handle_Search__=True;
    ...
    function MyMod_Handle_Search_Form_Should()
    {
        ...
        if
            (
                !empty($this->CGI_GETint("NoSearch"))
                ||
                !$this->__MyMod_Handle_Search__
            )
        {
            $res=False;
        }
       ...
       )
   {
      ...
      $searchvarstable=
          $this->MyMod_Handle_Search_Form_Should($searchvarstable);
