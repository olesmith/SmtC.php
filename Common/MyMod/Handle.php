    ...
    function MyMod_Handle_Item_Read()
    {
        ...
        if (empty($this->ItemHash))
        {
            ...
            (
                ...
                ": item not found or not allowed... (".$id.") - bye-bye.."
            );
        }
    ...
    function MyMod_Handle($args=array())
    {
        ...
        if (!empty($this->Actions[ $action ]))
        {
            ...
            if ($res)
            {
                ...
                {
                    $this->MyMod_Log_Entry($action.": MyMod_Handle");
                }
            ...
            {
                $this->ApplicationObj()->MyApp_Handle_Start();
    ...
    function MyMod_Handle_DocHeads($force=FALSE)
    {
        ...
        if ($latexdoc==0 || $force)
        {
                ...
                )
            {
                ...
                $this->ApplicationObj()->MyApp_Interface_HorMenu_Echo();
