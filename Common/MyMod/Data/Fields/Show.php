...
trait MyMod_Data_Fields_Show
{
    ...
    function MyMod_Data_Fields_Show($data,$item,$plural=FALSE,$iconify=TRUE,$callmethod=TRUE,$options=array(),$nohtml=False)
    {
        $this->ItemData($data);
        ...
        {
            $value=$this->MyMod_Data_Fields_Text_Show($data,$item,$value,$plural);
               ...
               )
        {
            ...
            {
                $file=$this->ItemData[ $data ][ "Iconify" ]."?".time();
        ...
        elseif ($this->MyMod_Data_Field_Is_Enum($data))
        {
               ...
               )
            {
                ...
                $classes=array($this->ModuleName,$item[ "ID" ],$data);
                    ...
                    )
                {
                    ...
                    (
                        $classes,
                        $this->ItemData[ $data ][ "Classes" ][ $val ]
                    );
                }
