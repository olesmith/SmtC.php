...
trait MyMod_Data_Fields_File
{
    ...
    //*
    //* Tests if uploaded file exists.
    //*

    function MyMod_Data_Fields_File_Exists($data,$item)
    {
        $file=
            $this->MyMod_Data_Fields_File_FileName($data,$item);

        return file_exists($file);
    }
    
    //*$plural,$links,$callmethod,$rdata 
    //*
