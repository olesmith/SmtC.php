...
trait MyMod_Data_Fields_Enums
{
    ...
    function MyMod_Data_Enum_Reverse_Select_Should($data)
    {
        return !empty($this->ItemData[ $data ][ "Select_Values_Reverse" ]);
    ...
    function MyMod_Data_Field_Enum_Edit($data,$item,$value,$tabindex,$plural,$links,$callmethod,$rdata,$ignoredefault=False,$options=array())
    {
        ...
        {
            return
                $this->MyMod_Data_Field_Enum_CheckBox
                (
                    $data,$value,$item,
                    $rdata
                );
        ...
        return
            ...
            (
                ...
                $this->MyMod_Data_Field_Enum_Options($data,$tabindex,$item,$options)
            );
    }
