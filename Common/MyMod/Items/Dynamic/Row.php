...
trait MyMod_Items_Dynamic_Row
{
    ...
    function MyMod_Item_Dynamic_Row($edit,$n,$item,$group)
    {
        ...
        $post_method=$this->ItemDataGroups($group,"Row_Post");
        if (!empty($post_method))
        {
            $row=
                array_merge
                (
                    $row,
                    $this->$post_method($edit,$n,$item,$group)
                );
        }
            ...
            )
        {
            $nn=
                ...
                (
                    array
                    (
                        $this->MyMod_Interface_Icon("fas fa-hand-point-down"),
                        $nn,
                    ),
                    array
                    (
                        "ONCLICK" => $this->JS_Table_Display_Next
                        (
                            $this->MyMod_Items_Dynamic_Table_Focus_Icons_Every,
                            "DROW",
                            "fas fa-hand-point-down fa-lg"
                        ),
                        "CLASS" => "ROWN",
                    )
                );
