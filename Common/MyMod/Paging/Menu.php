...
{    
    ...
    {
        //Disabled: moved to Search Options.
        return array();
        ...
        $rpages=$this->MyHashes_Page($rpages,$this->MyMod_Paging_Items_PerLine);

        $pages=array_keys($rpages);
        sort($pages,SORT_NUMERIC);
        ...
        foreach ($pages as $line)
        {
            ...
            (
                ...
                (
                    ...
                    (
                        "Paging",
                        $this->MyMod_Paging_Items_PerLine." Páginas: ",
                        $rpages[ $line ],
                        array()
                    ),
                    array
    ...
    function MyMod_Paging_Menu_Page_Item_Args($args,$page)
    {
        ...
        {
            $args[ $this->MyMod_Search_CGI_Include_All_Key() ]=2;
        }
