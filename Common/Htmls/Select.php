...
trait Htmls_Select
{
    ...
    function Htmls_Select_Field_Options_Title($name,$args,$selected,$values,$valuenames,&$options)
    {
        if (!empty($args[ "Title" ]))
        {
        ...
        elseif (!empty($selected))
        {
            ...
            for ($n=0;$n<count($values);$n++)
            {
                ...
                {
                    if (!empty($args[ "Titles" ]))
                    {
                        $options[ "TITLE" ]=$args[ "Titles" ][ $n ];
                    }
                    else
                    {
                        $options[ "TITLE" ]=$valuenames[ $n ];
                    }
                    break;
                }
            }
    ...
    function Htmls_Select_Field_Options($name,$args,$selected,$values,$valuenames,$options)
    {
        $options[ "NAME" ]=$name;

        $this->Htmls_Select_Field_Options_Title
        (
            $name,$args,$selected,$values,$valuenames,
            $options
        );
        ...
        {
            $options[ "ONCHANGE" ]=array();
        }

        if (!is_array($options[ "ONCHANGE" ]))
        {
            $options[ "ONCHANGE" ]=array($options[ "ONCHANGE" ]);
        }
    ...
    function Htmls_Select_Hashes_Field($fieldname,$items,$args=array(),$selectoptions=array(),$optionsoptions=array(),$divoptions=array())
    {
