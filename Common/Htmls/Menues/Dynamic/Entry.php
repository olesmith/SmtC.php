...
trait Htmls_Menues_Dynamic_Entry
{
    ...
    function Htmls_Menues_Dynamic_Entry($key,$is_last,$extras,$style=array())
    {
        return
            $this->Htmls_SPAN
            (
                ...
                array(),
                $this->Htmls_Menues_Dynamic_Entry_Style($key)
            );
    }
    ...
    function Htmls_Menues_Dynamic_Entry_Style($key)
    {
        if (!empty($this->_Entries_[ $key ][ "Style" ]))
        {
            return $this->_Entries_[ $key ][ "Style" ];
        }
