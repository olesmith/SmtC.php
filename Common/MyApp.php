...
trait MyApp
{
    ...
    var $MyApp_Interface_Head_Scripts=
        array
        (
        );
    ...
    //*
    //* Determines whether login to the system is disabled.
    //* Set up "Login_Disabled" in DBHash.
    //*

    function MyApp_Logon_May()
    {
        if ( !empty($this->DBHash[ "Login_Disabled" ])  )
        {
            return False;
        }
