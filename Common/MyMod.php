...
include_once("MyMod/CLI.php");

include_once("MyMod/LeftMenu.php");
...
{    
    ...
    var $MyMod_Sql_Update_Log=False;
    
    
    function MyMod_Log_Entry($msgs,$level=5)
    {
        return $this->ApplicationObj()->MyApp_Log_Entry($msgs,$level=5);
    }
    ...
    function MyMod_Interface_Mobile_Is()
    {
