...
trait MyApp_Login_Form
{
    ...
    function MyApp_Login_Form($msg1="",$msg2="")
    {
        ...
        (
            ...
            (
                "Login Form",
                $this->MyApp_Login_Form_Generate($msg1,$msg2)
            )
        );
    }
    ...
    function MyApp_Login_Form_Generate($msg1="",$msg2="")
    {
        return
            array
            (
    ...
    function MyApp_Login_Form_Trailer()
    {
        return
            array
            (
    ...
    function MyApp_Login_Form_URI()
    {
        ...
        $last_action=$this->CGI_GET("Action");
        if (!empty($last_action) && $last_action!="Logoff")
        {
            $uri[ "LastAction" ]=$last_action;
        }
