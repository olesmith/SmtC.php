...
trait MyApp_Session_Auth
{
    ...
    {
        $login=
            $this->MyApp_Session_Auth_CGI_Login();
    ...
    function MyApp_Session_Auth_CGI_Login()
    {
    ...
    function MyApp_Session_Auth_TooManyAttempts()
    {
        ...
        $this->MyApp_Log_Entry("Auth: ".$msg1);
    ...
    function MyApp_Session_Auth_InvalidLogin($login)
    {
        ...
        $this->MyApp_Log_Entry("Authentication: "."Invalid login: ".$login);
        $this->RegisterBadLogon();
     }
}
