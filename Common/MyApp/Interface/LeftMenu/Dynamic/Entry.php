...
trait MyApp_Interface_LeftMenu_Dynamic_Entry
{
    ...
    function MyApp_Interface_LeftMenu_Dynamic_Entry($base,$obj,$item,$action,$href,$cgivar,$name,$title,$class)
    {
        return
            ...
            (
                ...
                "Name" => array
                (
                    $this->MyApp_Interface_LeftMenu_Dynamic_Entry_Prefix("Add"),
                ),
                "Name_Hidden" => array
                (
                    $this->MyApp_Interface_LeftMenu_Dynamic_Entry_Prefix("Sub"),
                ),
    ...
    function MyApp_Interface_LeftMenu_Dynamic_Entry_Prefix($icon_type)
    {
        return
            $this->MyMod_Interface_Icon
            (
                $this->MyApp_Interface_LeftMenu_Dynamic_Entry_Prefix_Icon
                (
                    $icon_type
                ),
                array
    ...
    function MyApp_Interface_LeftMenu_Dynamic_Entry_Prefix_Icon($icon_type)
    {
        $icon=$this->__MyApp_Interface_LeftMenu_Dynamic_Add_Icon__;
        if ($icon_type=="Sub")
        {
            $icon=$this->__MyApp_Interface_LeftMenu_Dynamic_Sub_Icon__;
        }
