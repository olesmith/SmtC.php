...
trait MyDir
{
    ...
    //** $includepath is set, incudes full $path (default).
    //** 
    ...
    function Dir_Create_AllPaths($path,$tell=False)
    {
        ...
        {
            array_push($rcomps,$comps[ $n]);
            $rpath=join("/",$rcomps);

            if (!empty($comps[ $n]) && !is_dir($rpath))
            {
                $this->Dir_Create($rpath,$tell);
            }
    ...
    function MyDirs_HTML($title,$paths,$pre,$post)
    {
        return
            array
            (
    ...
    function MyDirs_Form($title,$paths,$pre,$post)
    {
        return
            array
            (
                ...
                (
                    ...
                    "ZIP_Form",
                    "",
                    $this->MyDirs_HTML($title,$paths,$pre,$post)
                )
            );
    }
