...
trait Sql_Insert
{
    ...
    {        
        ...
        if ($this->Sql_Insert_Echo)
        {
            $calls=debug_backtrace(False,2);

            $text=$calls[0][ 'file' ]." line ".$calls[0][ 'line' ];

            $text=$calls[1][ 'function' ]." ".$text;
            echo
                "Insert ID: ".$item[ "ID" ].
                " - caller: ".
                $this->CallStack_Callers_Info().
                "\n";
        }
