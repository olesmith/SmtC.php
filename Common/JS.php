...
include_once("JS/Window.php");
include_once("JS/Copy.php");
...
trait JS
{
    ...
    var
        ...
        $JS_Toggle_Elements_By_ID="Toggle_Elements_By_ID", 
        ...
        $JS_Opacity_Toggle="Opacity_Toggle",
        ...
        $JS_Load_URL_2_Element_Do="Load_URL_2_Element_Do",
        ...
        $JS_Table_Display_Next="Table_Display_Next",
        $JS_Clip_Board_Copy_URL="Clip_Board_Copy_URL",
        $JS_Select_Copy_To_Elements="Select_Copy_To_Elements",
        $JS_Input_Copy_To_Elements="Input_Copy_To_Elements",
        $JS_Input_Copy_To_Elements_ByID="Input_Copy_To_Elements_ByID",
        $JS_Window_Popup="Window_Popup",
        $JS_Copy_To="Copy_To",
        $JS_Input_Value_Set_Elements_ByID="Input_Value_Set_Elements_ByID",
        $JS_Input_Value_Set_Element_ByID="Input_Value_Set_Element_ByID",
        $JS_Input_Copy_To_Elements_ByID_If_Empty=
        "Input_Copy_To_Elements_ByID_If_Empty",
        $JS_Copy_InnerHtml="Copy_innerHtml",

        
        $JS_Select_Update_Register="Select_Update_Register",
        $JS_Select_Updated_Elements_Send="Select_Updated_Elements_Send";
